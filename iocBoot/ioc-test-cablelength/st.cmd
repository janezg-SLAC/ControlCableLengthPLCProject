...
#
#         Project: plc-test-cablelength.tsproj
#        PLC name: test_cablelength (test_cablelength Instance)
...
#   lcls-twincat-motion: * -> 4.0.7 (SLAC)
...
epicsEnvSet("LOCATION", "PLC:test_cablelength" )
...
epicsEnvSet("ADS_MAX_PARAMS",   "1129")
...
epicsEnvSet("PREFIX",         "PLC:test_cablelength:")
...
epicsEnvSet("MOTOR_PREFIX",    "TST:LAB:MMS:")
epicsEnvSet("MOTOR_NAME",      "01")
epicsEnvSet("DESC",            "GVL_Devices.M1 / CableTestAxis")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:test_cablelength")
dbLoadRecords("save_restoreStatus.db", "P=PLC:test_cablelength:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:test_cablelength,IDX=1")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:test_cablelength")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:test_cablelength,PROJECT=plc-test-cablelength.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.15.2.dev0+g73bd2d9.d20230727,PLC_HOST=172.21.148.78")

#   LCLS General: * -> 2.10.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:test_cablelength,DEPENDENCY=LCLS_General,VERSION=2.10.0,VENDOR=SLAC")
#   lcls-twincat-motion: * -> 4.0.7 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:test_cablelength,DEPENDENCY=lcls-twincat-motion,VERSION=4.0.7,VENDOR=SLAC")
#   PMPS: * -> 3.2.1 (SLAC - LCLS)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:test_cablelength,DEPENDENCY=PMPS,VERSION=3.2.1,VENDOR=SLAC - LCLS")
#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:test_cablelength,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:test_cablelength,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_Utilities: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:test_cablelength,DEPENDENCY=Tc2_Utilities,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:test_cablelength,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("test_cablelength.db", "PORT=$(ASYN_PORT),PREFIX=PLC:test_cablelength:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 129
callbackSetQueueSize(2258)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:test_cablelength:")
